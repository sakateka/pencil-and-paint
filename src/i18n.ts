...
const en: Dictionary = {
  ...
  'closer.well.line': 'somebody is down there looking up. they have not been coloured in either',
  'closer.scarecrow.title': "the scarecrow's face",
  'closer.scarecrow.line': 'two buttons that do not match, a mouth sewn on crooked, and a bird who has stopped pretending',
...
const es: Dictionary = {
  ...
  'closer.well.line': 'alguien mira hacia arriba desde ahí abajo. tampoco lo han coloreado',
  'closer.scarecrow.title': 'la cara del espantapájaros',
  'closer.scarecrow.line': 'dos botones que no hacen juego, una boca cosida torcida y un pájaro que ya ni disimula',
...
const pt: Dictionary = {
  ...
  'closer.well.line': 'alguém lá embaixo olha para cima. também não foi colorido',
  'closer.scarecrow.title': 'o rosto do espantalho',
  'closer.scarecrow.line': 'dois botões que não combinam, uma boca costurada torta e um pássaro que já nem finge',
...
const ru: Dictionary = {
  ...
  'closer.well.line': 'кто-то смотрит оттуда вверх. его тоже ещё не раскрасили',
  'closer.scarecrow.title': 'лицо пугала',
  'closer.scarecrow.line': 'две разные пуговицы, криво пришитый рот и птица, которая уже не притворяется',
...
const zh: Dictionary = {
  ...
  'closer.well.line': '有人在下面抬头看着你。他也还没有被涂上颜色',
  'closer.scarecrow.title': '稻草人的脸',
  'closer.scarecrow.line': '两颗对不上的扣子，一张缝歪了的嘴，还有一只早就懒得装样子的鸟',

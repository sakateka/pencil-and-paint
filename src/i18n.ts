...
const en: Dictionary = {
  ...
  'intro.details': 'how this load went',
  'intro.copy': 'copy',
  'intro.copied': 'copied',
  ...
  'prompt.look.scarecrow': 'look at his face',
  'closer.done': 'leave',
  'closer.well.title': 'down the well',
  'closer.well.line': 'colder than it looks, and deeper. the moss stops where the light does',
  'closer.scarecrow.title': "the scarecrow's face",
  'closer.scarecrow.line': 'two buttons that do not match, and a mouth sewn on crooked. somebody made this by hand',
...
const es: Dictionary = {
  ...
  'intro.details': 'cómo fue esta carga',
  'intro.copy': 'copiar',
  ...
  'prompt.look.scarecrow': 'mirarle la cara',
  'closer.done': 'irse',
  'closer.well.title': 'el fondo del pozo',
  'closer.well.line': 'más fría de lo que parece, y más honda. el musgo termina donde termina la luz',
  'closer.scarecrow.title': 'la cara del espantapájaros',
  'closer.scarecrow.line': 'dos botones que no hacen juego y una boca cosida torcida. alguien lo hizo a mano',
...
const pt: Dictionary = {
  ...
  'intro.details': 'como correu este carregamento',
  'intro.copy': 'copiar',
  'intro.copied': 'copiado',
  ...
  'prompt.look.scarecrow': 'olhar o rosto dele',
  'closer.done': 'ir embora',
  'closer.well.title': 'o fundo do poço',
  'closer.well.line': 'mais fria do que parece, e mais funda. o musgo acaba onde a luz acaba',
  'closer.scarecrow.title': 'o rosto do espantalho',
  'closer.scarecrow.line': 'dois botões que não combinam e uma boca costurada torta. alguém fez isto à mão',
...
const ru: Dictionary = {
  ...
  'intro.details': 'как прошла эта загрузка',
  ...
  'prompt.look.scarecrow': 'рассмотреть его лицо',
  'closer.done': 'уйти',
  'closer.well.title': 'на дне колодца',
  'closer.well.line': 'холоднее, чем кажется, и глубже. мох заканчивается там же, где свет',
  'closer.scarecrow.title': 'лицо пугала',
  'closer.scarecrow.line': 'две разные пуговицы и криво пришитый рот. кто-то шил это руками',
...
const zh: Dictionary = {
  ...
  'prompt.look.scarecrow': '看看他的脸',
  'closer.done': '离开',
  'closer.well.title': '井底',
  'closer.well.line': '比看上去更凉，也更深。青苔止于光照不到的地方',
  'closer.scarecrow.title': '稻草人的脸',
  'closer.scarecrow.line': '两颗对不上的扣子，一张缝歪了的嘴。有人是一针一针缝出来的',

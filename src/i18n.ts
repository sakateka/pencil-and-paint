...
const en: Dictionary = {
  ...
  'painting.elephant': 'an elephant hiding in the trees',
...
const es: Dictionary = {
  ...
  'painting.elephant': 'un elefante escondido entre los árboles',
...
const pt: Dictionary = {
  ...
  'painting.elephant': 'um elefante escondido entre as árvores',
...
const ru: Dictionary = {
  ...
  'painting.elephant': 'слон прячется среди деревьев',

...
const es: Dictionary = {
  ...
  'painting.lion': 'un león, con toda su melena',
...
const pt: Dictionary = {
  ...
  'studio.collection': 'e estes estiveram aqui o tempo todo',
  ...
  'painting.bullfinch': 'um dom-fafe no tramazeira',
...
const ru: Dictionary = {
  ...
  'studio.collection': 'а они всё это время были здесь',
  'painting.frogs': 'лягушки на пруду',
  ...
  'painting.lion': 'лев, во всей своей гриве',
...
const zh: Dictionary = {
  ...
  'studio.rubber': '擦掉',
  'studio.nib': '笔的粗细',
  'studio.collection': '它们一直都在这里',
  'painting.frogs': '池塘里的青蛙',
  'painting.hen': '母鸡和她的小鸡',
  'painting.owl': '林子里的猫头鹰',
  'painting.elephant': '没人相信的大象',
